...
public class SS_Electronics_41_Test extends SS_Electronics_Test{
	...
	public void TestCase_13() throws InterruptedException {
		...
		WebElement dropDown=addAddress.getStateDropDown();
		Select dd=new Select(dropDown);
		
		dd.selectByValue("Maharashtra");
		
		String selectedOption = dd.getFirstSelectedOption().getText();
		Assert.assertEquals(selectedOption, "Maharashtra","PASSED");
		}
}
