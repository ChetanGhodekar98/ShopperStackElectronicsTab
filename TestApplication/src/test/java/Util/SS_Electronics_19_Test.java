...
public class SS_Electronics_19_Test extends SS_Electronics_Test{
	...
	public void TestCase_13() throws InterruptedException {
		...
		addAddress.getHouseOfficeInfoTextField().sendKeys("yewalewadi");
		
		Thread.sleep(2000);
		
		String color=addAddress.getHouseOfficeInfoTextField().getCssValue("color");
