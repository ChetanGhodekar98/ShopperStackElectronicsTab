...
public class SS_Electronics_32_Test extends SS_Electronics_Test{
	...
	public void TestCase_13() throws InterruptedException {
		...
		addAddress.getLandmarkTextField().sendKeys("nagar x cross @#");
		
		Thread.sleep(2000);
		
		String color=addAddress.getLandmarkTextField().getCssValue("color");
